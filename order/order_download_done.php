...
try
{
  ...
  $csv='ordercode,orderdate,membernumber,name,email,postalcode,address,tel,productcode,productname,price,quantity';
  $csv.="\n";
  while(true)
  {
...
<a href="chumon.csv">download ordered data</a><br/>
<br/>
<a href="order_download.php">go to select day page</a><br/>
<br/>
